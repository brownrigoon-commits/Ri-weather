...
SOURCES = {
    ...
    # 구장 공식 홈페이지분 — 2026-08-01 추가. 사이트가 구장마다 다르므로 site 는 참고용이다.
    # ⚠️ 표기를 '公式ホームページ' 로 둔 이유: 아코디아 출처가 'アコーディア・ゴルフ 公式サイト' 라
    #    '公式サイト' 를 표기로 쓰면 --remove official 이 **아코디아 104곳까지 지운다**
    #    (2026-08-01 실제로 그렇게 잡혔다 — 통지 온 날 엉뚱한 자료를 내릴 뻔했다).
    "official":  {"mark": "公式ホームページ", "name": "구장 공식 홈페이지", "site": "(구장별)"},
}
