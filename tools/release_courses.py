...
from check_holequality import holes_from_db, check_tip, check_menu, check_ja, check_img
_hq_rows = holes_from_db()
_hq_bad = (check_tip(_hq_rows) + check_menu(_hq_rows)
           + check_ja(_hq_rows) + check_img(_hq_rows))
if _hq_bad:
